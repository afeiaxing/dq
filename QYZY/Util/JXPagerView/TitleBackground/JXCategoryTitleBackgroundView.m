...
- (void)initializeData {
    ...
    self.normalBackgroundColor = UIColor.whiteColor;// [UIColor lightGrayColor];
    self.normalBorderColor = [UIColor clearColor];
    self.selectedBackgroundColor = UIColor.whiteColor;// [[UIColor orangeColor] colorWithAlphaComponent:0.3];
