//
//  QYZYHeroismListViewController.m
//  QYZY
//
...
@interface QYZYHeroismListViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
@property (nonatomic,strong)UITableView *tableView;
@property (nonatomic ,strong) QYZYRankViewModel *viewModel;
@property (nonatomic ,strong) NSArray<QYZYRankModel *> *rankArray;
@end

@implementation QYZYHeroismListViewController
...
- (void)requestRankData {
    weakSelf(self);
    [self.viewModel requestRankDataWithtype:@(3) isDay:NO completion:^(NSArray<QYZYRankModel *> * _Nonnull array) {
        strongSelf(self);
