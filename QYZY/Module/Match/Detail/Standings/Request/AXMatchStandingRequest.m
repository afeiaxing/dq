...
- (void)requestMatchTextLiveWithMatchId:(NSString *)matchId
    ...
    [batchRequest startWithCompletionBlockWithSuccess:^(YTKBatchRequest * _Nonnull batchRequest) {
        ...
        AXMatchStandingTextLiveApi *api3 = (AXMatchStandingTextLiveApi *)requests[1];
        AXMatchStandingTextLiveApi *api4 = (AXMatchStandingTextLiveApi *)requests[1];
        ...
        if (array2.count) {
            [dict setValue:array1 forKey:@"Q2"];
        }
        if (array3.count) {
            [dict setValue:array1 forKey:@"Q3"];
        }
        if (array4.count) {
            [dict setValue:array1 forKey:@"Q4"];
        }
